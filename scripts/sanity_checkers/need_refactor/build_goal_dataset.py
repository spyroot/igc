#!/usr/bin/env python3
"""Build legacy GoalExtractor / GoalEncoder datasets from captured Redfish JSON.

PARKED: this helper is retained for Phase 1/2/3 refactor reference only. It is
not the current labelled-request producer and not a training artifact source.
