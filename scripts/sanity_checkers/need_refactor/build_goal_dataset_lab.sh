...
# scripts/sanity_checkers/need_refactor/build_goal_dataset.py. PARKED: this is
# legacy goal-dataset plumbing retained for refactor reference, not the current
# Phase 2/3 producer. Do not run it on the operator laptop.
...
build_dataset() {
	...
	local args=(
		"${PYTHON_BIN}" "${REPO_ROOT}/scripts/sanity_checkers/need_refactor/build_goal_dataset.py"
