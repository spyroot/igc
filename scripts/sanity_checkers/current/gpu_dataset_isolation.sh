...
#   bash scripts/sanity_checkers/current/gpu_dataset_isolation.sh            # default sweep on available GPUs
#   CASE_TIMEOUT=60 WORLDS="1 2 4" bash scripts/sanity_checkers/current/gpu_dataset_isolation.sh
set -u
