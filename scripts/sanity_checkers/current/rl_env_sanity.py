...
Usage:
    torchrun --nproc_per_node=4 scripts/sanity_checkers/current/rl_env_sanity.py

Local CPU development only:
    python scripts/sanity_checkers/current/rl_env_sanity.py --allow-cpu --num-envs 2 --steps 2
