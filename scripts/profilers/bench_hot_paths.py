...
Usage:
    python scripts/profilers/bench_hot_paths.py                       # default corpus
    python scripts/profilers/bench_hot_paths.py --corpus redfish_ctl/tests/hpe_fixtures
    python scripts/profilers/bench_hot_paths.py --profile             # + cProfile critical sections
