...
#   bash scripts/profilers/run_profile.sh
#
#   # override a profile field, or pass extra igc_main flags after --:
#   IGC_PROFILE=phase1_3b_lora IGC_SET="batch_size=16 lr=2e-4" bash scripts/profilers/run_profile.sh -- --recreate_dataset
#   IGC_PROFILE=phase1_gpt2_smoke IGC_SET="max_steps=10" bash scripts/profilers/run_profile.sh
#
