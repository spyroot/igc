...
#   scripts/nv72/gb300_distribute_image.sh
#   DIST_NODES="<node-ip> <node-ip>" scripts/nv72/gb300_distribute_image.sh           # subset
#   FORCE_SAVE=1 scripts/nv72/gb300_distribute_image.sh                               # re-save tarball
#
