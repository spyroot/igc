...
#
# Runs scripts/sanity_checkers/current/dist_sanity.py under torchrun in the NGC/igc-train container for a ladder
...
#   SANITY_NODES="<node-ip> <node-ip>" scripts/nv72/gb300_sanity_check.sh           # runs 1,4,8
#   SANITY_GPUS="1 4" scripts/nv72/gb300_sanity_check.sh                            # single-node only
#   IGC_IMAGE=igc-train:ngc26.03-py3 SANITY_NODES="…" scripts/nv72/gb300_sanity_check.sh
#
...
SCRIPT="${SANITY_SCRIPT:-scripts/sanity_checkers/current/dist_sanity.py}"  # or scripts/sanity_checkers/current/dataset_sanity.py (dataset feed)
