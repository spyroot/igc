...
class TestExactMatch(unittest.TestCase):
    ...
    def test_exact_match(self):
        ...
        for prompt_type, expected_result in zip(prompt_types, expected_results):
            result = LlmModule.performance_metric(predictions, targets, MetricType.EXACT_MATCH, prompt_type)
    ...
    def test_performance_metric_question(self):
        ...
        expected_result = 1.0
        result = LlmModule.performance_metric(predictions,
                                              expected_answers,
    ...
    def test_question_normalization(self):
        ...
        normalized_questions = [
            LlmModule._normalize(p, "Q") for p in predictions
        ]
    ...
    def test_rouge_metric_negative(self):
        ...
        result = LlmModule.performance_metric(predictions,
                                              ...
                                              MetricType.ROUGE,
                                              PromptType.CUSTOM,
                                              callback=LlmModule.compute_rouge_metric)
