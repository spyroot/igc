...
def test_build_tokens_accepts_allowable_values(tmp_path):
    ...
    pipeline._allowable_values = {"BootSourceOverrideTarget": ["Pxe", "Hdd", 1, True, None]}
    ...
    # numbers/booleans coerce to their text form; None is dropped, not fatal.
    assert tokenizer.convert_tokens_to_ids("1") != tokenizer.unk_token_id
