"""Offline tests for ``scripts/sanity_checkers/need_refactor/sample_goal_dataset.py``.
...
SCRIPT = REPO_ROOT / "scripts" / "sanity_checkers" / "need_refactor" / "sample_goal_dataset.py"
