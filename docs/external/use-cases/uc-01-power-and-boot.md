...
> **Target loop, not shipped code.** This page describes the intended end-to-end IGC agent loop,
> grounded in `docs/external/architecture/overview.md`. Today the current unlock path is Phase 1/2/3;
> the behavior below is a target RL workflow, not a shipped runtime.
