...
def emit_final_run_report(
    ...
    :param final_epoch_loss: Last epoch's average loss, or ``None`` if no epoch ran.
    ...
    :param validation_accuracy: Last validation accuracy used for report metrics.
    ...
    :param checkpoint_path: Final checkpoint directory/path recorded in the manifest.
