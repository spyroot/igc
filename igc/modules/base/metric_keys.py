...
PHASE2_WANDB_METRIC_KEYS = (
    ...
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "json_parse_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "set_match_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "set_exact_match_rate"),
    ...
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "duplicate_api_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "invalid_api_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "cardinality_accuracy"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "empty_set_exact_match_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "set_exact_match_rate_k1"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "set_exact_match_rate_k2"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "set_exact_match_rate_k3"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "heldout_vendor_or_model_set_exact"),
)
...
PHASE3_WANDB_METRIC_KEYS = (
    ...
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "json_parse_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "call_set_exact_match_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "rest_api_set_match_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "rest_api_coverage_exact_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "http_method_exact_match_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "operation_name_exact_match_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_match_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "argument_schema_valid_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "argument_value_grounding_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "readonly_empty_arguments_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "invalid_method_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "missing_call_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "extra_call_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "duplicate_call_rate"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "call_set_exact_match_rate_k1"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "call_set_exact_match_rate_k2"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "call_set_exact_match_rate_k3"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_read_only_empty"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_patch_scalar"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_patch_nested"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_post_no_arguments"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_post_one_argument"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_post_multiple_arguments"),
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "arguments_exact_delete_no_body"),
)
