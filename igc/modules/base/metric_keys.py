...
PHASE2_WANDB_METRIC_KEYS = (
    ...
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "empty_set_match_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "missing_required_api_rate"),
    phase_metric(PHASE2_GOAL_EXTRACT, "eval", "extra_api_rate"),
...
PHASE3_WANDB_METRIC_KEYS = (
    ...
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "rest_api_exact_match_rate"),
    ...
    phase_metric(PHASE3_ARGUMENT_EXTRACT, "eval", "unsupported_argument_rate"),
